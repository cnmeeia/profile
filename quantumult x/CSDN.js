...
if (/<\/html>|<\/body>/.test(body)) {
  body = body.replace('</body>', `<script src='https://cdn.jsdelivr.net/npm/jquery.cookie/jquery.cookie.js'></script><script src='https://cdn.jsdelivr.net/npm/nprogress@0.2.0/nprogress.js'></script><script src='https://cdn.jsdelivr.net/npm/clipboard@2.0.6/dist/clipboard.min.js'></script>
<script>
...
function common(num, times) {
    var loop = setInterval(function () {
        ...
        if (num === 1) {
            ...
            configHTML += '<br>';
            configHTML += '<button id="save" style="position: absolute; top: 20px; right: 15px;" onclick="location.reload()">' + save_svg + ' 保存并应用</button>';
            configHTML += '<br>';
